...
pub fn all_tools() -> Vec<serde_json::Value> {
    vec![
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "attachments": {
                        "type": "array",
                        "items": { "type": "string" },
                        "description": "Optional list of local file paths to attach. Each path must point to a readable file on disk (e.g. a CSV, PDF, image, .xlsx, or ZIP you created). The MIME type is inferred from the extension."
                    }
                },
        ...
        serde_json::json!({
            "name": "reply",
            "description": "Reply to an existing message, optionally replying to all recipients. Can attach files you generated by passing their local paths in 'attachments'.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "message_id": {
                    ...
                    "attachments": {
                        "type": "array",
                        "items": { "type": "string" },
                        "description": "Optional list of local file paths to attach to the reply. Each path must point to a readable file on disk (e.g. a CSV, PDF, image, .xlsx, or ZIP you created). The MIME type is inferred from the extension."
                    }
                },
